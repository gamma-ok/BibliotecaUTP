...
public class frmCliente extends javax.swing.JFrame {
    ...
    public frmCliente() {
        ...
        Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("../Icons/clients.png"));
        this.setIconImage(icon);
        
        String[] titulo = new String[] {"ID", "Descripción", "Dirección", "Teléfono", "RUC"};
    ...
    void guardar() {
        ...
        if (id.isEmpty() || descripcion.isEmpty() || direccion.isEmpty() || telefono.isEmpty() || ruc.isEmpty()) {
            return;
        }

        dtm.addRow(new Object[]{id, descripcion, direccion, telefono, ruc});
        limpiar();
    }
    ...
    void editar() {
        ...
        String direccion = txtDireccion.getText().trim();
        String telefono = txtTelefono.getText().trim();
        String ruc = txtTelefono.getText().trim();
    ...
    private void initComponents() {
        ...
        titulo.setText("GESTIÓN DE CLIENTES");
        ...
        informacion.setText("Datos de Cliente");
        ...
        getContentPane().add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 490, -1));
        ...
        getContentPane().add(direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 230, -1));
        ...
        getContentPane().add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 230, 20));

        telefono.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        telefono.setForeground(new java.awt.Color(255, 255, 255));
        telefono.setText("Teléfono:");
        getContentPane().add(telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 150, 170, -1));
        ...
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 170, 170, 20));

        ruc.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ruc.setForeground(new java.awt.Color(255, 255, 255));
        ruc.setText("RUC:");
        getContentPane().add(ruc, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 150, 170, -1));

        txtRuc.setBackground(new java.awt.Color(232, 240, 250));
        ...
        getContentPane().add(txtRuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 170, 170, 20));
        ...
        getContentPane().add(jScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, 650, 130));
    ...
    private void tablaClientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClientesMousePressed
        ...
        if (evt.getClickCount() == 1) {
            txtId.setText(tablaClientes.getValueAt(tablaClientes.getSelectedRow(), 0).toString());
            txtDescripcion.setText(tablaClientes.getValueAt(tablaClientes.getSelectedRow(), 1).toString());
            txtDireccion.setText(tablaClientes.getValueAt(tablaClientes.getSelectedRow(), 2).toString());
            txtTelefono.setText(tablaClientes.getValueAt(tablaClientes.getSelectedRow(), 3).toString());
            txtRuc.setText(tablaClientes.getValueAt(tablaClientes.getSelectedRow(), 4).toString());
        }
