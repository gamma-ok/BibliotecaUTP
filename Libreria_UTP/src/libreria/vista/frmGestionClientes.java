...
public class frmGestionClientes extends javax.swing.JFrame {
    ...
    public frmGestionClientes() {
        ...
        String[] titulo = new String[]{"Nombre", "Apellido", "DNI", "Celular", "Email", "Dirección"};
        dtm.setColumnIdentifiers(titulo);
        tGestionClientes.setModel(dtm);
        tGestionClientes.getTableHeader().setReorderingAllowed(false);
        tGestionClientes.setDefaultEditor(Object.class, null);
    ...
    public void centrarTabla() {
        JTableHeader header = tGestionClientes.getTableHeader();
        ...
        for (int i = 0; i < tGestionClientes.getColumnCount(); i++) {
            tGestionClientes.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
        }
    }
    ...
    private void initComponents() {
        ...
        tGestionClientes = new javax.swing.JTable();
        ...
        tituloForm.setText("Gestión de Clientes");
        ...
        infoForm.setText("Datos de Cliente");
        ...
        id.setText("ID:");
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 150, 30, 20));
        ...
        getContentPane().add(txtIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 150, 310, 20));

        nombre.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        nombre.setForeground(new java.awt.Color(255, 255, 255));
        nombre.setText("Nombre:");
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 340, 20));
        ...
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 340, 20));

        apellido.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        apellido.setForeground(new java.awt.Color(255, 255, 255));
        apellido.setText("Apellido:");
        getContentPane().add(apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 190, 340, -1));
        ...
        getContentPane().add(txtApellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 210, 340, 20));

        dni.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        dni.setForeground(new java.awt.Color(255, 255, 255));
        dni.setText("DNI:");
        getContentPane().add(dni, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 340, -1));
        ...
        getContentPane().add(txtDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, 340, 20));

        celular.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        celular.setForeground(new java.awt.Color(255, 255, 255));
        celular.setText("Celular");
        getContentPane().add(celular, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 250, 340, -1));
        ...
        getContentPane().add(txtCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 270, 340, 20));

        email.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        email.setForeground(new java.awt.Color(255, 255, 255));
        email.setText("Email:");
        getContentPane().add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 340, -1));

        txtEmail.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        txtEmail.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 2, 2, 2));
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 330, 340, 20));

        direccion.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        direccion.setForeground(new java.awt.Color(255, 255, 255));
        direccion.setText("Dirección:");
        getContentPane().add(direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 310, 340, -1));
        ...
        getContentPane().add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 330, 340, 20));
        ...
        getContentPane().add(btnNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 130, 40));
        ...
        getContentPane().add(bgBtnNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 130, 40));
        ...
        getContentPane().add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, 130, 40));
        ...
        getContentPane().add(bgBtnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, 130, 40));
        ...
        getContentPane().add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 400, 130, 40));
        ...
        getContentPane().add(bgBtnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 400, 130, 40));
        ...
        getContentPane().add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 400, 130, 40));
        ...
        getContentPane().add(bgBtnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 400, 130, 40));
        ...
        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libreria/recursos/search.png"))); // NOI18N
        btnBuscar.setText(" Buscar");
        btnBuscar.setBorder(null);
        btnBuscar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnBuscar.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 400, 130, 40));

        bgBtnBuscar.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        bgBtnBuscar.setForeground(new java.awt.Color(255, 255, 255));
        bgBtnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libreria/recursos/bgBtnFrm.png"))); // NOI18N
        getContentPane().add(bgBtnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 400, 130, 40));

        jScrollPane.setBorder(null);

        tGestionClientes.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tGestionClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nombre", "Apellido", "DNI", "Celular", "Email", "Dirección"
            }
        ) {
        ...
        tGestionClientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tGestionClientesMousePressed(evt);
            }
        });
        jScrollPane.setViewportView(tGestionClientes);
    ...
    private void tGestionClientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tGestionClientesMousePressed
        int row = tGestionClientes.getSelectedRow();
        if (row != -1) {
            txtNombre.setText(tGestionClientes.getValueAt(row, 0).toString());
            txtApellido.setText(tGestionClientes.getValueAt(row, 1).toString());
            txtDni.setText(tGestionClientes.getValueAt(row, 2).toString());
            txtCelular.setText(tGestionClientes.getValueAt(row, 3).toString());
            txtEmail.setText(tGestionClientes.getValueAt(row, 4).toString());
            txtDireccion.setText(tGestionClientes.getValueAt(row, 5).toString());
        }
    }//GEN-LAST:event_tGestionClientesMousePressed
    ...
    public javax.swing.JTable tGestionClientes;
